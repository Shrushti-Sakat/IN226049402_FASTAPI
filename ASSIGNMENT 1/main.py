...
# ─── Products List (Q1: 7 products total) ───
products = [
    ...
    {"id": 3, "name": "Notebook", "price": 199, "category": "Stationery", "in_stock": True},
    {"id": 4, "name": "Pen Set", "price": 49, "category": "Stationery", "in_stock": False},
    # Q1 — 3 new products added below
...
# ─── Q1: Get All Products (total should be 7) ───
@app.get("/products")
def get_products():
